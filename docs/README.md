# [Plantilla bootstrap utilizada](https://startbootstrap.com/template-overviews/resume/)
...
Esta plantilla la usamos con el fin de llevar una documentación visible y clara para cualquier persona que quiera entender en que consiste el proyecto, desde su planteamiento, hasta sus funciones y sus diagramas de diseño.

### Modificaciones

Se le realizaron modificaciones para que brinde una experiencia de uso más comoda.
